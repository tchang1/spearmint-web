...
exports.validateGoal= function(req,res,next) {
	req.checkBody('name', "Empty or invalid goal name").notEmpty().isAlphanumeric();
	req.checkBody('amountSaved', "Empty or invalid goal amount").isNumeric();
	req.checkBody('targetAmount', "Empty or invalid goal name").isNumeric();
